...
//�ο�https://blog.csdn.net/caoshangpa/article/details/78913718
/*
���ǵ���ֲ�Լ�����ԣ�LevelDB��ϵͳ��صĴ������ļ�/����/ʱ�䣩�����Evn���û������Լ�ʵ����Ӧ�Ľӿڣ�
��Ϊoption��һ���ִ��룬Ĭ��ʹ���Դ���ʵ�֡�
*/ //PosixEnv�̳и��࣬���ո�ֵ��EnvWrapper.target_
    class Env { //�������̳߳�ʵ�ֽ��̳���PosixEnv      DBImpl.env_
    public:
...
//�����WritableFile��SequentialFile��RandomAccessFile���ֱ����ļ���д�����࣬˳���������������������
//PosixEnv���а����⼸�����new�ӿ�   PosixSequentialFile�̳и���
...
//�����WritableFile��SequentialFile��RandomAccessFile���ֱ����ļ���д�����࣬˳���������������������
//PosixEnv���а����⼸�����new�ӿ�  PosixRandomAccessFile�̳и���
...
//�����WritableFile��SequentialFile��RandomAccessFile���ֱ����ļ���д�����࣬˳���������������������
//PosixEnv���а����⼸�����new�ӿ�   PosixWritableFile�̳и���
    class WritableFile {
    public:
        WritableFile()
...
/*
    Log�ļ���ϵͳ�е�������Ҫ������ϵͳ�����ָ�������ʧ���ݣ�����û��Log�ļ�����Ϊд��ļ�¼�տ�ʼ�Ǳ������ڴ��еģ�
��ʱ���ϵͳ�������ڴ��е����ݻ�û�����ü�Dump�����̣����Իᶪʧ���ݣ�Redis�ʹ���������⣩��Ϊ�˱������������
rocksdb��д���ڴ�ǰ�Ƚ�������¼��Log�ļ��У�Ȼ���ټ����ڴ��У�������ʹϵͳ������Ҳ���Դ�Log�ļ��лָ��ڴ��е�Memtable��
����������ݵĶ�ʧ��

   log�ļ����������µ�db���£�ÿ�����¶���append�ķ�ʽ׷�ӵ��ļ���β����log�ļ��ﵽԤ����Сʱ��ȱʡ��Լ4MB����
leveldb�Ͱ���ת��Ϊһ���������������һ���µ�log�ļ���
*/
//��Logger��log�ļ���д��ӿ� LoggerWrapper��̳и���
    class Logger { //PosixLogger�̳и���
    public:
